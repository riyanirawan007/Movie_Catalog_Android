package app.android.rynz.imoviecatalog.data.contentmanager;
...
import app.android.rynz.imoviecatalog.data.provider.MainProvider;
import app.android.rynz.imoviecatalog.view.service.MainService;

import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_BACKDROP_PATH;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_BELONG_COLLECTION;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_BUDGET;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_FOR_ADULT;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_GENRES;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_HOMEPAGE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_ID;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_IMDB_ID;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_ORI_LANGUAGE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_ORI_TITLE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_OVERVIEW;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_POPULARITY;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_POSTER_PATH;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_PRODUCTION_COMPANIES;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_PRODUCTION_COUNTRIES;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_REALEASE_DATE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_REVENUE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_RUNTIME;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_SPOKEN_LANGUAGE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_STATUS;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_TAGLINE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_TITLE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_VIDEO;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_VOTE_AVERAGE;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite.COLUMN_MOVIE_VOTE_COUNT;
import static app.android.rynz.imoviecatalog.data.db.MainDBContract.TableFavorite._ID;
import static app.android.rynz.imoviecatalog.data.provider.MainProvider.CONTENT_URI;
...
public class FavoriteManager
{
    ...
    * */
    ...
    public static void getAllFavorite(@NonNull final Context context, boolean asyncTask,@Nullable final MainService.FavoriteContent.onGetAllListener listener)
    {
        ...
        else
        {
            ...
            if(listener!=null) listener.onCompleted(items);
        }
    }
    ...
    public static void getFavoriteByMovieID(@NonNull final Context context,@NonNull final String id,@Nullable final MainService.FavoriteContent.onGetByIDListener listener)
    {
        ...
        class doTask extends AsyncTask<Void, Void, FavoriteMovie>
        {
            ...
            protected FavoriteMovie doInBackground(Void... voids)
            {
                Uri uri=Uri.parse(MainProvider.CONTENT_URI.toString()
                        .concat("/"+ MainProvider.PATH_BY_MOVIEID)
                        .concat("/"+id));
